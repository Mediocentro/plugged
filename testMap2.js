       ...
       var consumerIcon = [image.meterOff,
        ...
        snapshot.forEach(function(data){
          ...
          var infoContent = '<h2>Info</h2> <hr/> ID: ' + CoordTitle + '<br />Type: ' + typeText + '<br />Status: ' + conditionText;}
                  ...
                  var infoContent = '<h2>Info</h2> <hr/> ID: ' + CoordTitle + '<br />Type: ' + typeText + '<br />Status: ' + conditionText + '<table style = "width: 50%"><tr><th></th><th></th><th></th><th></th><th></th></tr><tr><td></td>   <td></td><td>f:</td><td>'+ uploadvals['f'] + '</td><td></td><td></td></tr><tr><td>V<sub>a</sub>:</td><td>' + uploadvals['Va'] + '</td><td>V<sub>b</sub>:</td><td>'+ uploadvals['Vb'] + '</td><td>V<sub>c</sub>:</td><td>' +uploadvals['Vc'] +'</td></tr><tr><td>I<sub>a</sub>:</td><td>' + uploadvals['Ia'] + '</td><td>I<sub>b</sub>:</td><td>'+uploadvals['Ib']+'</td><td>I<sub>c</sub>:</td><td>' + uploadvals['Ic'] + '</td></tr><tr><td></td><td></td><td>I<sub>n</sub>:</td><td>'+uploadvals['In']+'</td><td></td><td></td></tr><tr><td>P<sub>a</sub>:</td><td>'+uploadvals['Pa']+'</td><td>P<sub>b</sub>:</td><td>'+uploadvals['Pb']+'</td><td>P<sub>c</sub>:</td><td>'+uploadvals['Pc']+'</td></tr><tr><td>Q<sub>a</sub>:</td><td>'+uploadvals['Qa']+'</td><td>Q<sub>b</sub>:</td><td>'+uploadvals['Qb']+'</td><td>Q<sub>c</sub>:</td><td>'+uploadvals['Qc']+'</td></tr><tr><td>S<sub>a</sub>:</td><td>'+uploadvals['Sa']+'</td><td>S<sub>b</sub>:</td><td>'+uploadvals['Sb']+'</td><td>S<sub>c</sub>:</td><td>'+uploadvals['Sc']+'</td></tr><tr><td>pf<sub>a</sub>:</td><td>'+uploadvals['pfa']+'</td><td>pf<sub>b</sub>:</td><td>'+uploadvals['pfb']+'</td><td>pf<sub>c</sub>:</td><td>'+uploadvals['pfc']+'</td></tr><tr><td></td><td></td><td>pf<sub>t</sub>:</td><td>'+uploadvals['pft']+'</td><td></td><td></td></tr><tr><td></td><td></td><td>Ph<sub>AB</sub>:</td><td>'+uploadvals['phab']+'</td><td></td><td></td></tr><tr><td></td><td></td><td>Ph<sub>AC</sub>:</td><td>'+uploadvals['phac']+'</td><td></td><td></td></tr></table>';}
          if(CoordType == "C"){
